...
export function SideWatchlist() {
  ...
  const trendingTokens = [
    { symbol: 'HYPE', name: 'Hyperliquid', price: '$32.45', change: 156.7 },
    { symbol: 'ZEREBRO', name: 'Zerebro', price: '$0.12', change: 89.3 },
    { symbol: 'AI16Z', name: 'AI16Z', price: '$1.45', change: 67.8 },
    { symbol: 'VIRTUAL', name: 'Virtual', price: '$2.78', change: 45.2 },
  ];
